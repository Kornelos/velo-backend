...
class CaptchaService(
        val googleRecaptchaProperties: GoogleRecaptchaProperties,
        val restTemplate: RestTemplate
) {


    fun validateNotRobot(captchaResult: String): Boolean{
        val uriBuilder = UriComponentsBuilder.fromHttpUrl(googleRecaptchaProperties.url)
                .queryParam("secret", googleRecaptchaProperties.key)
